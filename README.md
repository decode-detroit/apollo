...
* Installation of GTK+: https://www.gtk.org/ (This is usually installed already on GNU/Linux systems. Search for package libgtk-4-0, and libgtk-4-dev if you'd like to compile Apollo.)
